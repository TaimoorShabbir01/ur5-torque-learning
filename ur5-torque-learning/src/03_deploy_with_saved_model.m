%% 03_deploy_with_saved_model.m
% Load a saved model and deploy

assert(isfile('../myTrainedModel.mat'), 'Could not find ../myTrainedModel.mat. Run 01_generate_data_and_train.m first.');
...
figure('Name','UR5 Deployment (from saved model)'); clf
show(ur5, initialConfig, 'Visuals','on','Frames','on');
title('UR5 Manipulator - Deployment (Loaded Model)');
...
disp('Starting model deployment (loaded model)...');
